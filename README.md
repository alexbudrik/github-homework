...
```
######## 7. Настройка конфигурации Zabbix Server
```   
    ...
    Setting up zabbix-sql-scripts ...
```
######### 8.Запуск и проверка Zabbix Server
```
...
```
########## 9. Настройка веб-интерфейса
```
    браузер: http://10.0.2.3/zabbix/setup.php
...
```
    ...
    # restart has no output if successful
    ...
    ● zabbix-agent.service - Zabbix Agent
         ...
         Active: active (running) since Tue 2026-...; Xs ago
       Main PID: XXXX (zabbix_agentd)
          Tasks: X
          Memory: XX.XM
          CPU: X.XXXs
```
...
![AgentLastData2](https://github.com/alexbudrik/sys-pattern-homework/blob/main/screenshots/agent%20latest%20data%20bottom.png)
