...
![haproxy.cfg](https://github.com/alexbudrik/sys-pattern-homework/blob/main/haproxy%202.cfg)
...
![haproxy.cfg](https://github.com/alexbudrik/sys-pattern-homework/blob/main/haproxy.cfg)
